...
sb3_buffer = SB3_Buff_Adapter(ReplayBuffer(1_000, env.observation_space, env.action_space))#, optimize_memory_usage=True, handle_timeout_termination=False))
# sb3_buffer = Buffer(10_000, env.observation_space.sample(), env.action_space.sample())

our_buffer = Buffer(1_000, env.observation_space.sample(), env.action_space.sample())
...
for batch_size in np.arange(3,7):
